...
let fee = new class {
    ...
    * getSettlementFee(site,symbol){
     ...
     * @api public
     */
    * getTradeFee(express,site,symbol){
        var platform = configUtil.getPlatform(site);
        ...
        let fee = 0;
        if(symbolItem){
            fee = yield* this._getExpressFee(symbolItem.tradeFee,express);
        }
