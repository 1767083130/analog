...
var betweenStrategyLogModel = function () {
    const BetweenStrategyLogSchema = mongoose.Schema({
        ...
        operates: [{
            ...
            actionIds: [],
            side: String, //buy或sell。当action=trade时有效
     ...
     * Methods
     */
    BetweenStrategyLogSchema.methods = {
    }
    
    /**
     * Statics
     */
    BetweenStrategyLogSchema.statics = {
    ...
    BetweenStrategyLogSchema.plugin(paginate);
    return mongoose.model('BetweenStrategyLog', BetweenStrategyLogSchema);
};


module.exports = new betweenStrategyLogModel();
