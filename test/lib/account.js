...
describe('账户测试. path: account.js', function () {
    ...
    it('refreshAccountTrading 委托成交后更改账户信息', function (done) {
        co(function *(){
            ...
            account = yield* accountController.refreshAccountTrading(order, type);  
    ...
    it('refreshAccountTransfering 转币后更改账户信息', function (done) {
        co(function *(){
            let stepAmount = 10;
            let transfer = {
            ...
            let res = yield* accountController.refreshAccountTransfering(transfer, type);
            ...
            type = 'bargain';
            oldEthCoin = newEthCoin;
            res = yield* accountController.refreshAccountTransfering(transfer, type);
            account = res.sourceAccount;
            newEthCoin = testUtil.getAccountCoin('eth',account);  
    ...
    it('syncAllAccounts', function (done) {
        co(function *(){
            /**
             * 同步用户的帐户持仓情况
             *
             ...
             * @api public
             */
            yield* accountController.syncAllAccounts(function(stepRes){
