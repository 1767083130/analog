...
describe('计算币种加权价格测试. path: transferStrategys/orderPriceUtil.js', function () {
    ...
    it('getSymbolPrice 计算币种加权价格', function (done) {     
        let realPriceItems = [
            { symbol: "btc#cny", side: "buy", prices: [[1,108]] },
            { symbol: "etc#btc", side: "buy", prices: [[0.24,108],[0.26,108]] },
            { symbol: "eth#btc", side: "buy", prices: [[0.5,108]] }
        ];
    ...
    it('getMutilSymbolsPrice 计算多个币种加权价格', function (done) {     
        let realPriceItems = [
            { site: "test_site",symbol: "btc#cny", side: "buy", prices: [[1,108]] },
            { site: "test_site",symbol: "etc#btc", side: "buy", prices: [[0.24,108],[0.26,108]] },
            { site: "test_site", symbol: "eth#btc", side: "buy", prices: [[0.5,108]] }
        ];
